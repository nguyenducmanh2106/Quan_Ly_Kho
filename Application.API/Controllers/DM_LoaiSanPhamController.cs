...
namespace Application.API.Controllers
{
    [ApiController]
    //[Authorize]
    [Route("api/dm_loaisanpham")]
    public class DM_LoaiSanPhamController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IDM_LoaiSanPhamServices _manager;

        public DM_LoaiSanPhamController(IConfiguration config, IDM_LoaiSanPhamServices _manager)
        {
            _config = config;
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] DM_LoaiSanPhams obj)
        {
            try
            {
                var objAdd = new DM_LoaiSanPhams()
                {
                    Name = obj.Name,
                    Status = obj.Status,
                    Code = obj.Code,
        ...
        [HttpPost("update")]
        public async Task<IActionResult> Update([FromBody] DM_LoaiSanPhams obj)
        {
            try
            {
        ...
        [HttpPost("delete")]
        public async Task<IActionResult> Delete([FromBody] DM_LoaiSanPhams obj)
        {
            try
            {
