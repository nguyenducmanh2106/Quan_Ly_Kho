...
namespace Application.API.Controllers
{
    [ApiController]
    //[Authorize]
    [Route("api/dm_thuoctinh")]
    public class DM_ThuocTinhController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IDM_ThuocTinhServices _manager;

        public DM_ThuocTinhController(IConfiguration config, IDM_ThuocTinhServices _manager)
        {
            _config = config;
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] DM_ThuocTinhs obj)
        {
            try
            {
                var objAdd = new DM_ThuocTinhs()
                {
                    Name = obj.Name,
                    Status = obj.Status,
                    Code = obj.Code,
                    ...
                    NhomThuocTinh_Id = obj.NhomThuocTinh_Id,
        ...
        [HttpPost("update")]
        public async Task<IActionResult> Update([FromBody] DM_ThuocTinhs obj)
        {
            try
            {
        ...
        [HttpPost("delete")]
        public async Task<IActionResult> Delete([FromBody] DM_ThuocTinhs obj)
        {
            try
            {
