        ...
        result = array != [] ? array.map((item, index) => {
            return (
                <tr key={item.id}>
                    ...
                    {_isPermission(constantPermission.EDIT, constantPermission.DM_DONVI) || _isPermission(constantPermission.DELETE, constantPermission.DM_DONVI) ?
                        <td className="text-center">
                            <Dropdown placement="bottomCenter" overlay={() => (
                                <Menu>
                                    {_isPermission(constantPermission.EDIT, constantPermission.DM_DONVI) ?
                        ...
                        <div className="ant-table-content">
                            <table style={{ tableLayout: "auto" }}>
                                ...
                                <i className="fa fa-sort"></i>
                                        ...
                                        <th className="sapxep text-center" id="CapDo" onClick={() => onSort("CapDo")}>
                                            Cấp đơn vị
                                <i className="fa fa-sort"></i>
                                        </th>
