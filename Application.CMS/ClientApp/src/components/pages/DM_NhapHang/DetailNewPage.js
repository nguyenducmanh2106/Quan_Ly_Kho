...
const ModalCreate = () => {
  ...
  const menu = (
    <Menu>
      {_isPermission(PERMISSION.DUYET, PERMISSION.DM_NHAPHANG) &&
      nhapHang?.status == 0 ? (
      ...
      {_isPermission(PERMISSION.EDIT, PERMISSION.DM_NHAPHANG) &&
        ...
        <Col xs={{ span: 24 }} md={{ span: 24 }} lg={{ span: 18 }}>
          ...
          >
            ...
            <Steps.Step
              ...
              title="Nhập kho"
              description={
                nhapHang.ngayNhapKho && nhapHang?.status != 4
                  ? moment(nhapHang.ngayNhapKho).format("DD/MM/YYYY, HH:mm")
                  : ""
              }
            />
            {nhapHang?.status != 4 ? (
              ...
              <Steps.Step
                title={<Typography.Text type="danger">Huỷ đơn</Typography.Text>}
                description={
                  nhapHang.ngayHuyDon
      ...
      <Row>
        <Col style={{ textAlign: "right" }}>
          ...
          _isPermission(PERMISSION.DUYET, PERMISSION.DM_NHAPHANG) ? (
            ...
            _isPermission(PERMISSION.NHAPKHO, PERMISSION.DM_NHAPHANG) ? (
            <Button
              type="primary"
              icon={<AntdIcons.SaveOutlined />}
