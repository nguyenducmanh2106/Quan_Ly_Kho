        ...
        result = array != [] ? array.map((item, index) => {
            return (
                <tr key={item.id}>
                    ...
                    {_isPermission(constantPermission.EDIT, constantPermission.PERMISSION) || _isPermission(constantPermission.DELETE, constantPermission.PERMISSION) ?
                        <td className="text-center">
                            <Dropdown placement="bottomCenter" overlay={() => (
                                <Menu>
                                    {_isPermission(constantPermission.EDIT, constantPermission.PERMISSION) ?
                                    ...
                                    {_isPermission(constantPermission.DELETE, constantPermission.PERMISSION) ?
