                                            ...
                                            <div className="form-horizontal">
                                                ...
                                                <div className="form-group">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-9">
                                                            <textarea className="form-control" id="Description" name="Description" ref={register()}>{item?.description}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-9">
                                                            <input className="form-control" id="Code" name="Code" type="text" placeholder="Mã quyền" ref={register()} defaultValue={item?.code} />
