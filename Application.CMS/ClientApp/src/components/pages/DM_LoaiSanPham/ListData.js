        ...
        result = array != [] ? array.map((item, index) => {
            return (
                <tr key={item.id} className="ant-table-row ant-table-row-level-0">
                    ...
                    {_isPermission(constantPermission.EDIT, constantPermission.DM_LOAISANPHAM) || _isPermission(constantPermission.DELETE, constantPermission.DM_LOAISANPHAM) ?
                        <td>
                            <Dropdown placement="bottomCenter" overlay={() => (
                                <Menu>
                                    {_isPermission(constantPermission.EDIT, constantPermission.DM_LOAISANPHAM) ?
                                    ...
                                    {_isPermission(constantPermission.DELETE, constantPermission.DM_LOAISANPHAM) ?
